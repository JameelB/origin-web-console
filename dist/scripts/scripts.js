...
B.state.breakpoint = v.getBreakpoint();
...
B.filteredDeploymentConfigsByApp = ke(B.filteredDeploymentConfigs), B.filteredReplicationControllersByApp = ke(B.filteredReplicationControllers), B.filteredDeploymentsByApp = ke(B.filteredDeployments), B.filteredReplicaSetsByApp = ke(B.filteredReplicaSets), B.filteredStatefulSetsByApp = ke(B.filteredStatefulSets), B.filteredDaemonSetsByApp = ke(B.filteredDaemonSets), B.filteredMonopodsByApp = ke(B.filteredMonopods), B.apps = _.union(_.keys(B.filteredDeploymentConfigsByApp), _.keys(B.filteredReplicationControllersByApp), _.keys(B.filteredDeploymentsByApp), _.keys(B.filteredReplicaSetsByApp), _.keys(B.filteredStatefulSetsByApp), _.keys(B.filteredDaemonSetsByApp), _.keys(B.filteredMonopodsByApp)), s.sortAppNames(B.apps), Re();
}, Te = function() {
...
var t = _e(e);
return t ? Ue(e) ? [ e ] : _.get(B, [ "state", "podsByOwnerUID", t ], []) : [];
}, xe = function(e, t) {
var n = _e(e);
...
return O(e, "deploymentConfig");
}, it = function() {
if (B.deploymentConfigs && B.replicationControllers) {
var e = [];
B.replicationControllersByDeploymentConfig = {}, B.currentByDeploymentConfig = {}, ye = {};
var t = {}, n = {};
_.each(B.replicationControllers, function(r) {
var a = ot(r) || "";
(!a || !B.deploymentConfigs[a] && _.get(r, "status.replicas")) && e.push(r);
var o = ye[a];
o && !z(r, o) || (ye[a] = r);
var i;
"Complete" === O(r, "deploymentStatus") && ((i = t[a]) && !z(r, i) || (t[a] = r)), at(r) && _.set(n, [ a, r.metadata.name ], r);
...
}), B.vanillaReplicationControllers = _.sortBy(e, "metadata.name"), We();
}
}, st = function(e, t) {
...
B.replicaSets && fe && (B.replicaSetsByDeploymentUID = P.groupByControllerUID(B.replicaSets), B.currentByDeploymentUID = {}, _.each(B.replicaSetsByDeploymentUID, function(e, t) {
if (t) {
var n = fe[t], r = _.filter(e, function(e) {
return st(e, n);
}), a = p.sortByRevision(r);
B.replicaSetsByDeploymentUID[t] = a, B.currentByDeploymentUID[t] = _.head(a);
}
...
if (q(t)) {
e.push(t);
var n = l.usesDeploymentConfigs(t), r = Ce(t);
_.set(B, [ "deploymentConfigsByPipeline", r ], n), _.each(n, function(e) {
...
be.bindingsByApplicationUID[n] = [], be.deleteableBindingsByApplicationUID[n] = [], _.each(t, function(t, a) {
t.covers(r) && (be.bindingsByApplicationUID[n].push(be.bindings[a]), _.get(be.bindings[a], "metadata.deletionTimestamp") || be.deleteableBindingsByApplicationUID[n].push(be.bindings[a]), be.applicationsByBinding[a] = be.applicationsByBinding[a] || [], be.applicationsByBinding[a].push(e));
});
});
...
var p, f, g = {}, v = {};
u.SERVICE_CATALOG_ENABLED && U(le, "watch") && (p = function(e) {
var t = T.getServiceClassNameForInstance(e);
if (!t) return n.when();
var r = _.get(be, [ "serviceClasses", t ]);
return r ? n.when(r) : (g[t] || (g[t] = m.get(ce, t, {}).then(function(e) {
...
if (!t) return n.when();
var r = _.get(be, [ "servicePlans", t ]);
return r ? n.when(r) : (v[t] || (v[t] = m.get(ue, t, {}).then(function(e) {
...
var u = this, d = a.getPreferredVersion("serviceinstances"), m = a.getPreferredVersion("clusterserviceclasses"), p = a.getPreferredVersion("mobileclients"), f = e("isServiceInstanceReady"), g = [];
u.projectName = n.project, u.emptyMessage = "Loading...", u.alerts = {}, r.breadcrumbs = [ {
title: "Mobile Clients",
link: "project/" + u.projectName + "/browse/other?kind=MobileClient&group=" + p.group
}, {
title: n.mobileclient
} ], u.validUrlPattern = l, u.setDmzUrl = function(e) {
var t = angular.copy(u.mobileClient);
t.spec.dmzUrl = e, o.update(a.getPreferredVersion("mobileclients"), u.mobileClient.metadata.name, t, u.projectContext).then(function() {
c.addNotification({
type: "success",
message: "Successfully updated the DMZ URL for " + u.mobileClient.metadata.name
});
});
}, s.get(u.projectName).then(_.spread(function(a, i) {
return u.project = a, u.projectContext = i, t.all([ o.list(m, u.projectContext), o.list(d, i), o.get(p, n.mobileclient, i, {
errorNotification: !1
}) ]).then(_.spread(function(e, t, a) {
u.loaded = !0, u.serviceClasses = e.by("metadata.name"), u.serviceInstances = t.by("metadata.name"), u.mobileClient = a;
var s = _.get(u, "mobileClient.metadata.annotations.service_instance_name"), c = _.get(u, [ "serviceInstances", s, "spec", "clusterServiceClassRef", "name" ]);
u.coreSdkSetup = _.get(u, [ "serviceClasses", c, "spec", "externalMetadata", "documentationUrl" ]), g.push(o.watchObject(p, n.mobileclient, i, function(e, t) {
"DELETED" === t && (u.alerts.deleted = {
type: "warning",
message: "This mobile client has been deleted."
}), u.mobileClient = e;
})), g.push(o.watch(d, i, function(e) {
r.serviceInstances = e.by("metadata.name"), u.mobileCIService = _.find(r.serviceInstances, function(e) {
return /aerogear-digger/.test(e.metadata.name);
}), u.mobileCIProvisioning = "Provision" === _.get(u, "mobileCIService.status.currentOperation"), u.mobileCIDeprovisioning = "Deprovision" === _.get(u, "mobileCIService.status.currentOperation"), u.mobileCIEnabled = f(u.mobileCIService);
}));
}), function(t) {
u.loaded = !0, u.alerts.load = {
type: "error",
...
})), u.goToMobileServices = function() {
i.toProjectCatalog(u.projectName, {
category: "mobile",
...
n.statefulSets = e.by("metadata.name"), n.statefulSetsLoaded = !0, T(), l.log("statefulSets", n.statefulSets);
}, {
poll: g,
pollInterval: 6e4
...
var n = e.getPreferredVersion("servicebindings"), r = e.getPreferredVersion("serviceinstances"), a = this, o = [];
a.$onChanges = function(e) {
var r = _.get(e, "mobileClient.currentValue"), i = _.get(e, "serviceClasses.currentValue");
r && i && 0 === o.length && o.push(t.watch(n, {
namespace: a.context
}, function(e) {
a.bindings = _.filter(e.by("metadata.name"), function(e) {
return _.get(e, [ "metadata", "annotations", "binding.aerogear.org/consumer" ]) === _.get(a, "mobileClient.metadata.name");
}), a.addDetailsToBindings();
}));
}, a.addDetailsToBindings = function() {
t.list(r, {
namespace: a.context
}, function(e) {
var t = e.by("metadata.name");
a.serviceSdkInfo = _.map(a.bindings, function(e) {
var n = t[_.get(e, [ "metadata", "annotations", "binding.aerogear.org/provider" ])], r = a.serviceClasses[_.get(n, "spec.clusterServiceClassRef.name")];
return {
...
sdkDocs: _.get(r, "spec.externalMetadata.sdk-docs-" + a.mobileClient.spec.clientType),
