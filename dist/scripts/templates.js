angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/_mobile-service-sdk-docs.html',
    ...
    "<div class=\"col-md-12\">\n" +
    "<img class=\"logo\" ng-src=\"{{sdkInfo.logo}}\">\n" +
    ...
    "<h5>\n" +
    "<a href=\"{{sdkInfo.sdkDocs}}\">{{sdkInfo.displayName}} SDK setup</a>\n" +
    "</h5>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>"
  ...
  $templateCache.put('views/browse/mobile-clients.html',
    ...
    "<h4>\n" +
    "<a href=\"{{ctrl.coreSdkSetup}}\">{{ctrl.mobileClient.spec.clientType | upperFirst}} SDK setup</a>\n" +
    "</h4>\n" +
    "</div>\n" +
    ...
    "<button class=\"btn btn-primary btn-lg\" ng-click=\"ctrl.goToMobileServices()\">Browse Mobile Catalog</button>\n" +
    "</div>\n" +
